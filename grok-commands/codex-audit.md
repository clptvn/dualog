...
If $ARGUMENTS is empty, use **ask_user_question** to ask what files to audit.
...
**If there's persistent disagreement (2+ rounds on the same issue):** Ask the user to decide using ask_user_question.
